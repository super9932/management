...
import { COMMON_MANAGING_DEPT } from '../constant';
...
interface Props {
  rows: InsuranceCommonRow[];
  total: number;
  pageSize: number;
  selectedIds: ReadonlySet<number>;
  onToggle: (id: number) => void;
  onToggleAll: () => void;
  onDocumentClick: (row: InsuranceCommonRow) => void;
}
...
export default function InsuranceCommonTable({
